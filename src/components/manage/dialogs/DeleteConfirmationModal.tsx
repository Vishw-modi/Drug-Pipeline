...
export function DeleteConfirmationModal({ isOpen, onClose, onConfirm, entityName, isDeleting }: DeleteConfirmationModalProps) {
  return (
      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <DialogPanel className="relative transform overflow-hidden rounded-lg bg-[var(--color-surface)] px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-slate-500">
                        Are you sure you want to delete <span className="font-semibold text-slate-900">"{entityName}"</span>? 
