        ...
        <div className="flex-1 max-w-xl">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-background border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary focus:bg-surface transition-all text-brand-navy"
            />
          </div>
        </div>
