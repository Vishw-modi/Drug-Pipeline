...
export function DonutChart({ data, colorScheme = 'default' }: DonutChartProps) {
  ...
  const renderLegend = (props: any) => {
    ...
    return (
      <ul className="flex flex-col gap-2.5 m-0 p-0 sm:pl-2 list-none text-xs text-[var(--color-brand-navy)] w-full max-w-sm mx-auto sm:max-w-none">
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center w-full gap-4 sm:gap-0 min-h-[260px]">
      <div className="w-full sm:w-[45%] h-[200px] sm:h-[260px]">
      ...
      <div className="w-full sm:w-[55%] flex justify-center sm:justify-start px-2 sm:px-0">
